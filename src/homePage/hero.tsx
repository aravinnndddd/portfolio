...
export function Hero() {
  return (
    <div className="relative md:mt-[-10vh] flex flex-col md:flex-row h-auto md:h-[105vh] w-full bg-white text-white text-center px-6 py-16 md:py-0 overflow-hidden">
      ...
      {/* Left Section - Intro */}
      <div className="relative z-10 flex flex-col justify-center items-center  w-full md:w-1/2 px-4 md:px-12">
        ...
        <p className="mt-4 max-w-2xl text-sm  sm:text-lg md:text-xl text-black/70">
        ...
        {/* <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-4">
          <button className="p-3 rounded-xl border-2 bg-white/70 text-black font-medium hover:bg-white hover:shadow-black shadow-sm shadow-black duration-500 hover:shadow-2xl transition">
            Let&apos;s Connect
          </button>
          <button className="p-3 rounded-xl border-2 bg-white/80 backdrop-blur-xl text-black font-medium hover:bg-white hover:shadow-black duration-500 hover:shadow-2xl shadow-sm transition">
            View Projects
          </button>
        </div> */}
